...
# Load data
df = pd.read_csv("./data/Classification_data3.csv")
...
# Define the model
#servono delle curve chise per saparare bene le classi
#kernel lineare, poco buono
model = SVC(kernel="linear")
#kernel polinomiale non va bene
model = SVC(kernel="poly", degree=3)
#kernel rbf ottimo 
model = SVC(kernel="rbf", gamma=10)

#non esiste un kernel ottimo in generale,
#ma quello più adatto a quel dataset
